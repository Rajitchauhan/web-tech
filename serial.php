...
<head>
    ...
    <script>
        function showAdditionalOptions() {
            ...
            switch (selectedOption) {
                ...
                case 'CertificateCompletion':
                    ...
                    break;
                case 'Course':
                    courseSelect.style.display = 'block'; // Added this line
                    inputBox.style.display = 'none';
                    break;
                default:
                    inputBox.style.display = 'block';
        ...
        function loadCourses() {
            ...
            // Make an AJAX request to fetch course names from the server
            var xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    var courses = JSON.parse(xhr.responseText);

                    // Add options to the courseSelect
            ...
            xhr.open("GET", "load_courses.php", true);
            xhr.send();
        }
...
<div class="container mt-5">
    ...
    <form method="post" action="filter_data.php">
        ...
        <div id="prefixOption" style="display: none;">
            <label for="userInput" class="form-label">Select Option:</label>
            <select class="form-select" onchange="setPrefix(this.value)">
                <option value="EGA">Normal</option>
                <option value="EGAP">Project</option>
            </select>
        </div>
        ...
        <div id="courseSelect" style="display: none;">
            ...
            <select class="form-select" name="selectedCourse"></select>
        </div>
