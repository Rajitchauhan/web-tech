...
<div class="container mt-5">
    ...
    <form method="post" action="filter_data.php">
        <div class="mb-3">
            ...
            <select class="form-select" id="filterOption" name="filterOption" onchange="showAdditionalOptions(); loadSecondSelection();">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
 ...
 <script>
    function loadSecondSelection() {
        var firstSelection = document.getElementById('filterOption');
